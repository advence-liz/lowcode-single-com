...
function fillRealVersion(meta, packageName = 'single-com', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [SingleComMeta];
const components = [];
const npmInfo = {};
...
if (!execCompile) {
  window.SingleComMeta = { components, componentList };
}